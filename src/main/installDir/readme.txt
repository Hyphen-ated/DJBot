...
Run start.bat to run it.
(if you have java installed but it's not on your PATH, you can edit start.bat and replace "java" with an absolute path to your java exe)
